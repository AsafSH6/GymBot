...
FACEPALMING_EMOJI = emoji.emojize(':person_facepalming:')
KISSING_HEART_EMOJI = emoji.emojize(':face_blowing_a_kiss:')
LYING_FACE_EMOJI = emoji.emojize(':lying_face:')
TROPHY_EMOJI = emoji.emojize(':trophy:')
